...
(use-package org-roam
  ...
  :bind (("s-d l" . org-roam-buffer-toggle)
         ...
         ("s-d I" . org-roam-node-insert-immediate)
         ("s-d p" . my/org-roam-find-project)
         ("s-d t" . my/org-roam-capture-task)
         ("s-d b" . my/org-roam-capture-inbox)
         ("s-d B" . my/org-roam-capture-index)
         :map org-mode-map
